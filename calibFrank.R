...
for (rep in 1:nbrep){
  ...
  #Save results
  saveRDS(chain,file=paste("chain",copFamily,rep,sep="_"))
  saveRDS(meanAdapt,file=paste("init",copFamily,rep,sep="_"))
  saveRDS(ar,file=paste("AR",copFamily,rep,sep="_"))
  saveRDS(batch,file=paste("batch",copFamily,rep,sep="_"))
  saveRDS(dev,file=paste("dev",copFamily,rep,sep="_"))
